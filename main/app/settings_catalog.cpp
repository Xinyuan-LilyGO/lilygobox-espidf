...
constexpr SettingsEntry kSettingsEntries[] = {
    ...
    {.id = "mobile_network",
        ...
        .value = "",
        .icon = SettingsIcon::kCellTower,
        .divider_before = false},
    {.id = "connect_share",
        .title = "Connect Share",
        .value = "",
        .icon = SettingsIcon::kAppList,
        .divider_before = false},
    {.id = "personal_hotspot",
    ...
    {.id = "vpn",
        .title = "VPN",
        .value = "",
        .icon = SettingsIcon::kHome,
        .divider_before = false},
    {.id = "more_connections",
        .title = "More Connections",
        .value = "",
        .icon = SettingsIcon::kFile,
        .divider_before = false},
    {.id = "wallpaper",
        .title = "Wallpaper",
        .value = "",
        .icon = SettingsIcon::kImage,
        .divider_before = true},
    {.id = "lock_screen",
        .title = "Lock Screen",
        .value = "",
        .icon = SettingsIcon::kFolder,
        .divider_before = false},
    {.id = "notifications",
        .title = "Notifications",
        .value = "",
        .icon = SettingsIcon::kWarning,
        .divider_before = false},
    {.id = "sound",
        .title = "Sound",
        .value = "",
