...
constexpr int kWifiPasswordVisibilityButtonSize = 58;
constexpr int kWifiPasswordVisibilityButtonRight = 10;
constexpr int kWifiPasswordInputRightPadding = 84;
constexpr int kWifiPasswordKeyboardHeightPercent = 35;
constexpr size_t kWifiPasswordMinLength = 8;
constexpr size_t kWifiPasswordInputMaxLength = 63;
...
struct SettingsViewState {
  ...
  lv_obj_t* wifi_password_visibility_button = nullptr;
  lv_obj_t* wifi_password_visibility_icon = nullptr;
