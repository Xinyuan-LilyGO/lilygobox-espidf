 ...
 * Size: 56 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 56 --font assets\icon\material_symbols\MaterialSymbolsRoundedFill.ttf -r 58834,58837,59576,61523,63687 --format lvgl --lv-font-name lvgl_font_material_symbols_fill_56 --lv-include lvgl.h -o main\ui\font\lvgl_font_material_symbols_fill_56.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 896, .box_w = 42, .box_h = 28, .ofs_x = 7, .ofs_y = 14},
    {.bitmap_index = 588, .adv_w = 896, .box_w = 38, .box_h = 38, .ofs_x = 9, .ofs_y = 9},
    {.bitmap_index = 1310, .adv_w = 896, .box_w = 46, .box_h = 48, .ofs_x = 5, .ofs_y = 4},
    {.bitmap_index = 2414, .adv_w = 896, .box_w = 38, .box_h = 43, .ofs_x = 9, .ofs_y = 7},
    {.bitmap_index = 3231, .adv_w = 896, .box_w = 47, .box_h = 48, .ofs_x = 4, .ofs_y = 4}
};
...
{
    {
        .range_start = 58834, .range_length = 4854, .glyph_id_start = 1,
